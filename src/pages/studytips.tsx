...
const StudyTips = (): JSX.Element => {
  ...
  useEffect(() => {
    fetchJson('/api/getvideo', {
      ...
      body: JSON.stringify({ videoType: 'studytips' }),
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="เกร็ดความรู้ - สถาบันศุภปัญญาไอ.เค." />
      </Head>
      <div id="content" className="container pt-5 pb-5">
        <h1 className="is-size-1 has-text-weight-bold">เกร็ดความรู้</h1>
